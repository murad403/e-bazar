    ...
    return (
        <div className="flex flex-col lg:flex-row items-center gap-5 md:gap-10 text-title">
            <div className="w-full flex flex-col md:flex-row lg:flex-col gap-3 *:w-full lg:w-[25%] *:h-[130px] *:py-5">
                <div className="bg-purple-200 flex flex-col justify-between rounded-xl text-center">
            ...
            <div className="w-full lg:w-[75%] bg-purple-200 rounded-xl md:p-5 p-3">
                ...
                <form className="space-y-3" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex justify-center items-center mt-5">
                        <button className="bg-basic py-2 w-1/2 rounded-lg text-white cursor-pointer" type="submit">
                            {
